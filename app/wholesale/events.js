...
const onIndexWholesale = function () {
...
const onShowWholesale = function (event) {
...
const onDeleteWholesale = function (event) {
  // prevent default submit action to stop the page from refreshing
  event.preventDefault()
...
const onUpdateWholesale = function (event) {
  // prevent default submit action to stop the page from refreshing
  event.preventDefault()
...
const onCreateWholesale = function (event) {
  // prevent default submit action to stop the page from refreshing
  event.preventDefault()
